...
def set_default_sort(user_id, setting, current_value):
    ...
    while True:
        ...
        print("  1. Service name (service)")
        print("  2. Date of first entry (created_at)")
        print("  3. Most recently updated (updated_at)")
        print()
        print("  0: Flip the display order of selections (Ex. A-Z becomes Z-A)")
        print()
        if value_error == True:
